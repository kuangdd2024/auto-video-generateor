...
请根据以上代码块的内容生成口语风格的文案；前面部分讲解内容核心，用比喻、排比等修辞，引用古诗词、谚语等名句；后半部分讲案例故事，用抖音电影解说风格，语言风趣幽默，情节跌宕起伏；整个文案限制在300字以内。"""

image_prompt_value = "图像内容：{} 图像限制：电影风格，写实主义，唯美画风，场景简单，背景纯净"
